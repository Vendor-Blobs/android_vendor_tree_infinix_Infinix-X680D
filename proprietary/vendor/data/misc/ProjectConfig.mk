...
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add custom macro by wanghanfeng 20191105 start
CUSTOM_BUILD_VERNO = CY-X680D-H6116-J
#BSP: add custom macro by wanghanfeng 20191105 end
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw gc8034_mipi_raw gc6153_serial_yuv pblcs5k3l6_mipi_raw pblcgc8034_mipi_raw pblcgc6153_serial_yuv
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3l6_17201599 gc8034_17201572 gc6153_17201615
...
# BSP: add XLBLBAEA-3 by kangping.liu for 20200217 start
CUSTOM_HAL_MSENSORLIB = mmc5603_x680
# BSP: add XLBLBAEA-3 by kangping.liu for 20200217 end
...
# BSP: modify XLBLDAEA-8 by kangping.liu for 20200311 start
CUSTOM_KERNEL_GYROSCOPE = yes
# BSP: modify XLBLDAEA-8 by kangping.liu for 20200311 end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw gc8034_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
# BSP: add XLBLBAEA-3 by kangping.liu for 20200217 end
#TSD:modify for XLBLHLYYL-1 by xiaochen.ye at 20200119 start
CUSTOM_MODEM = x680d_h6116_j1
#TSD:modify for XLBLHLYYL-1 by xiaochen.ye at 20200119 end
...
#BSP:modify audio bring up CLBLELEPUB-1 shuanglei.wang 20200218 start
MTK_AUDIO_NUMBER_OF_MIC = 1
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#BSP:modify audio bring up CLBLELEPUB-1 shuanglei.wang 20200218 end
...
#ITD:off mtk hdr by hongwei.liu 2020.03.09 begin
MTK_CAM_HDR_SUPPORT = no
#ITD:off mtk hdr by hongwei.liu 2020.03.09 end
...
MTK_IRTX_SUPPORT = no
#BSP: add for p1 debug CLBLEPUB-1118 by fan.hong 20200220 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP: add for p1 debug CLBLEPUB-1118 by fan.hong 20200220 end
MTK_K64_SUPPORT=no
...
#SPD: modify XLBLDAEA-9 for Scaler by zihan.guo 20/03/12 start
MTK_APP_RESOLUTION_TUNER_SUPPORT = yes
#SPD: modify XLBLDAEA-9 for Scaler by zihan.guo 20/03/12 end
...
################################ ITD Camera Tream start ###############################################
#[ITD]Add by mingwei.zhou 20200317 start
TRAN_FLASH_SLIDE_CONTROL = yes
#[ITD]Add by mingwei.zhou 20200317 end
#ITD:add cam 3pty function by shoufeng.zhao 20200228 start
TRAN_CAMERA_FEATURE = yes
TRAN_CAMERA_ANDROID_Q = yes
#ITD:add cam 3pty function by shoufeng.zhao 20200228 end
################################ ITD Camera Driver end ###############################################
#BSP: add custom macro by wanghanfeng 20191105 start
CUSTOM_TRAN_PROJECT=tran_x680d
CUSTOM_TRAN_BOM=tran_x680d_j1
TRAN_LCM_SUPPORT = yes
#SDD: add XLJLHLJY-17 by weike.xu 20191111 start
MTK_BUILD_VERNO=X680D-H6116J-Q-AS-200614V138
TRAN_FINGERPRINT_BUILD_VERNO=J-AS-200614V138
#SDD: add XLJLHLJY-17 by weike.xu 20191111 end
